...
import { 
  FaPhoneAlt, FaFacebookF, FaTwitter, FaInstagram, 
  FaUser, FaShoppingBag, FaTimes, FaPlus, FaMinus, FaTrash, FaSearch 
} from "react-icons/fa";
  ...
  return (
    <>
      ...
      <div className="w-full fixed top-0 z-50 bg-white shadow-md">
        ...
        {/* Seeds Mega Menu */}
        {openMenu === "seeds" && (
          <div className="absolute left-1/2 -translate-x-1/2 top-full w-[90vw] lg:w-[100vw] bg-[#fef7f7] rounded-lg py-6 px-10 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-6 z-40">
