...
const Sidebar = () => {
  ...
  return (
    <aside className="w-64 bg-[#e2e2e2] text-black min-h-screen p-6">
      <h2 className="text-1xl h-20 w-20 rounded-full bg-red-800 flex items-center mx-auto p-3 text-white font-bold mb-10">
        E-Shop
      </h2>
      <nav className="flex flex-col gap-4 text-gray-700 font-bold">
        ...
        <Link to="/admin/setting" className="hover:bg-gray-400 p-3 rounded-lg">
          Setting
        </Link>
        <Link
          to="/admin/blog_list"
